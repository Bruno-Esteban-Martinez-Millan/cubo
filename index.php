               ...
               <table>
                   ...
                   <?php 
                        ...
                        while($fila = $res->fetch_assoc()){
                            echo "<tr>";
                            echo "<td>".$fila["nombre"]."</td>";
                            $res3 = $obj->matrizDiciembre($fila["id"]);
                            $fila3 = $res3->fetch_assoc();
                            for($i = 1; $i<=15; $i++){
                                if($i == $fila3["id_cliente"]){
               ...
               <table>
                   <tr>
                       <?php 
                            ...
                            $contador = 1;
                            while($fila=$res->fetch_assoc()){
                                echo "<th id='cliente".$fila["id"]."'>".$fila["fecha"]."</th>";
                            }
                        ?>
                   </tr>
                   <?php 
                        ...
                        while($fila = $res->fetch_assoc()){
                            echo "<tr>";
                            echo "<td>".$fila["nombre"]."</td>";
                            $res2 = $obj->matrizProductos($fila["id"]);
                            $fila2 = $res2->fetch_assoc();
                            for($i = 1; $i<=27; $i++){
                                if($i == $fila2["id_cliente"]){
                                    echo "<td>".$fila2["cantidad"]."</td>";
